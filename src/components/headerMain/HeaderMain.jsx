...
function HeaderMain() {
  return (
    <div className='min-h-[585px] bg-cover bg-center bg-no-repeat flex items-top justify-center' style={{
      ...
      <div className='text-[#F8F3EF] pt-[60px] w-[492px]'>
        <h1 className='uppercase text-[42px] font-light text-center mb-[68px] leading-[125%] relative'>Качественные <span className='text-[#CF9B75]'>амбарные доски</span>
          <br></br> от производителя</h1>
        <p className='w-[161px] h-[161px] text-center text-[17px] italic text-[#E2AE80] absolute right-[230px] top-[210px] border border-[#E2AE80] rounded-[50%] p-[40px]'>Красота, созданная природой </p>
